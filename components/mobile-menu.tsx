...
export const MobileMenu = ({ className, variant = "landing" }: MobileMenuProps) => {
  ...
  const dashboardItems = [
    ...
    { name: "Caller ID", href: "/dashboard/caller-id" },
  ]

  const menuItems = variant === "landing" ? landingItems : dashboardItems
        ...
        >
          ...
          <nav className="flex flex-col space-y-6 container mx-auto">
            ...
            <div className="mt-6">
              ...
              >
                {variant === "landing" ? "Iniciar Sesión" : "Cerrar Sesión"}
              </Link>
            </div>
          </nav>
        </Dialog.Content>
